...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private List<Food> getListFood() {
        ...
        list.add(new Food(R.drawable.banhcuon,"Bánh cuốn","Bánh dai và rất ngon",Food.TypeNearBy));
        list.add(new Food(R.drawable.banhcuon,"Bánh cuốn","Bánh dai và rất ngon",Food.TypeNearBy));
        list.add(new Food(R.drawable.banhcuon,"Bánh cuốn","Bánh dai và rất ngon",Food.TypeNearBy));
        list.add(new Food(R.drawable.banhcuon,"Bánh cuốn","Bánh dai và rất ngon",Food.TypeNearBy));
        list.add(new Food(R.drawable.banhcuon,"Bánh cuốn","Bánh dai và rất ngon",Food.TypeNearBy));
        ...
        list.add(new Food(R.drawable.banhxeo,"Bánh xèo","Bán xèo giòn lắm",Food.TypeRecent));
        list.add(new Food(R.drawable.banhxeo,"Bánh xèo","Bán xèo giòn lắm",Food.TypeRecent));
        list.add(new Food(R.drawable.banhxeo,"Bánh xèo","Bán xèo giòn lắm",Food.TypeRecent));
        list.add(new Food(R.drawable.banhxeo,"Bánh xèo","Bán xèo giòn lắm",Food.TypeRecent));
        list.add(new Food(R.drawable.banhxeo,"Bánh xèo","Bán xèo giòn lắm",Food.TypeRecent));
